...
def main():
    ...
    print ("Print before modifying")
    print (servers)
    # display information about the servers to standard out
    print ("Display the First network device and IP")
    print(servers[0])     # display the first network device and IP
    
    print ("display JUST the IP address of the first host")
    print(servers[0][1])  # display JUST the IP address of the first host

    print ("display JUST the IP address of the third host")
